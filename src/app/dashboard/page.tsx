      ...
      <main className="container" style={{ paddingTop: "2.5rem", paddingBottom: "4rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
            <Link href="/criar-personagem" className="btn btn-ghost" style={{ flexShrink: 0, fontSize: "0.85rem" }}>
              + Criar Herói
            </Link>
            <Link href="/criar-personagem" className="btn btn-gold" style={{ flexShrink: 0, gap: "0.4rem" }}>
              <span>📐</span> Preencher Diagrama de Classe
            </Link>
          </div>
        </div>
